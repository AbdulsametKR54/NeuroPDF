...
// ✅ SVG ICONS (SVGR)
import MergeIcon from "@/assets/icons/merge_icon.svg";
import UploadIcon from "@/assets/icons/uploadingcloud.svg";
import ConvertIcon from "@/assets/icons/convert_card_icon.svg";
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0 flex items-center">
            ...
            >
              {/* Logo SVG hâlâ img ise renklendirmez; gerekirse bunu da SVGR yaparız */}
              <img
